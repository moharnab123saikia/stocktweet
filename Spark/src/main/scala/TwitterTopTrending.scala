...
object TwitterTopTrending {
  ...
  def getResult(granularity:String, fileName:String)=
  {
    ...
    granularity match
    {
      case "YEAR" =>
        ...
        resultYear.saveToCassandra("twitter_trending", "toptrendingyear", SomeColumns("year", "frequency", "ticker", "sentiment"))
      case "MONTH" =>
        ...
        resultMonth.saveToCassandra("twitter_trending", "toptrendingmonth", SomeColumns("year", "month", "frequency", "ticker", "sentiment"))
      case "WEEK"=>
        ...
        resultWeek.saveToCassandra("twitter_trending", "toptrendingweek", SomeColumns("year", "week", "frequency", "ticker", "sentiment"))
      case "DAY" =>
        ...
        resultDay.saveToCassandra("twitter_trending", "toptrendingday", SomeColumns("year", "month", "day", "frequency", "ticker", "sentiment"))
      case "HR" =>
        ...
        resultHr.saveToCassandra("twitter_trending", "toptrendinghour", SomeColumns("year", "month", "day", "hour", "frequency", "ticker", "sentiment"))
    }
  ...
  def main(args: Array[String])
  {
    if (args.length != 2)
    {
      System.err.println("Twitter Top Trending requires two argument")
      System.exit(1)
    }
